...
export const puppy_nutrition = `Una vez que el cachorro deja de ser amamantado es hora de hacer la transición a la comida 
...
export const adult_dog_nutrition = `Una vez que alcanza la adultez en el ciclo de vida del perro su cuerpo cambia y pasa de estar en proceso 
...
export const senior_dog_nutrition = `Alrededor de los siete años de edad, es recomendado darle alimento especial para mayores a tu perro. Estos alimentos
...
export const general_dog_nutrition_statement = `A continuación te daré unas recomendaciones según las caracerísticas de tu mascota. Las necesidades individuales 
...
export const general_cat_nutrition_statement = `A continuación te daré unas recomendaciones según las caracerísticas de tu mascota. Las necesidades individuales 
de tu mascota pueden variar, por lo tanto, es mejor consultar con el veterinario si no estás seguro de que tu perro requiere de una dieta específica. 
La mayoría de los gatos come una vez al día.`;

export const tiny_nutrition = `Si tu perro pesa entre 1 y 5 kg, la cantidad ideal de alimento son entre 35 y 100 gramos.
Si tu perro pesa entre 5 y 10 kg, la cantidad ideal de alimento son entre 100 y 150 gramos.`;

export const medium_nutrition = `Si tu perro pesa entre 11 y 25 kg, la cantidad ideal de alimento son entre 160 y 300 gramos.
Si tu perro pesa entre 25 y 35 kg, la cantidad ideal de alimento son entre 300 y 380 gramos.`;

export const giant_nutrition = `Si tu perro pesa entre 36 y 45 kg, la cantidad ideal de alimento son entre 400 y 470 gramos.
Si tu perro pesa entre 45 y 70 kg, la cantidad ideal de alimento son entre 470 y 630 gramos.`;

export const brachycephalic_nutrition = `Esta raza es braquicéfala, por lo que tienden a regurgitar la comida, debido a cuestiones fisiológicas: su tráquea es demasiado corta 
...
export const sensitive_stomach_nutrition = `Esta raza tiene estómago sensible, por lo que se recomienda alimento especial con una gran cantidad de proteínas de alta calidad que 
favorecen su digestión y el equilibrio de la flora intestinal.`;

export const obesity_nutrition = `Esta raza es propensa a engordar. Se recomienda que su alimento tenga: Proteína por encima del promedio, grasa por debajo del promedio,
...
export const dental_disease_nutrition = `Esta raza tiene tendencia a tener problemas dentales. Es recomendado darle bocadillos de salud dental. Estos bocadillos tienen
...
export const skin_problem_nutrition = `Esta raza tiene tendencia a tener problemas de piel. Una recomendación es darle alimento especial para el cuiado de piel. Estos alimentos 
contienen ingredientes como vitaminas del tipo B, ácidos grasos Omega 3, ácidos grasos Omega 6 y vitaminas C y E.`;

export const cat_general_nutrition = `Esta raza no tiene necesidades alimenticias especiales. ¡Puedes darle cualquier comida de calidad!`;

export const kitten_nutrition = `Los gatos bebés, a partir de las 8 semanas y hasta los 6 meses necesitarán entre 3 y 4 raciones al día, mientras que a partir de los 6 meses ya les puedes reducir el número de tomas a 2 diarias.De esta forma, a partir de las 8 semanas y hasta los 6 meses necesitarán entre 3 y 4 raciones al día, mientras que a partir de los 6 meses ya les puedes reducir el número de tomas a 2 diarias.`;

export const adult_cat_nutrition = `Una vez que tu gato se convierte en adulto (cuando cumple aproximadamente 1 año), y siempre y cuando tu minino lleve una vida activa, una comida al día puede ser lo más apropiado para él. 
