        ...
        switch (animal) {
            case "dog":
                return [ <
                    ...
                    key = "chihuahua" > Chihuahua < /Option>, <
                    Option value = "san bernardo"
                    key = "san bernardo" > San bernardo < /Option>, <
                    Option value = "golden"
                    key = "golden" > Golden < /Option>
                ]
            case "cat":
                return [ <
                    Option value = "blue russian"
                    key = "blue russian" > Blue < /Option>, <
                    Option value = "gardfield"
                    key = "gardfield" > Gardfield < /Option>, <
                    Option value = "fluffy"
                    key = "fluffy" > Fluffy < /Option>
                ]
            default:
                return []
        }
