...
adult_nutrition = '''Una vez que alcanza la adultez en el ciclo de vida del perro su cuerpo cambia y pasa de estar en proceso 
...
senior_nutrition = '''La mayoría de los dueños no hacen foco en el hecho de que con los años los perros adultos comienzan a desarrollar 
deficiencias cognitivas y un deterioro físico relacionado al ciclo de vida del perro alrededor de los siete años de edad. Estos cambios 
pueden requerir un cambio en la alimentación.'''

general_nutrition_statement = '''A continuación te daré unas recomendaciones según las caracerísticas de tu mascota. Las necesidades individuales 
